# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-05-29 07:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=30, verbose_name='Contexto cultural')),
                ('siglo_des', models.CharField(blank=True, max_length=30, verbose_name='Desde siglo:')),
                ('siglo_has', models.CharField(blank=True, max_length=30, verbose_name='Hasta siglo:')),
            ],
            options={
                'ordering': ['siglo_des'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exposicion', models.BooleanField(default=True, verbose_name='\xbfExpuesto?')),
                ('numinv', models.IntegerField(default=1, primary_key=True, serialize=False, unique=True, verbose_name='N\xfamero de inventario')),
                ('altura', models.DecimalField(decimal_places=2, max_digits=10)),
                ('ancho', models.DecimalField(decimal_places=2, max_digits=10)),
                ('propietario', models.CharField(choices=[('DJ', 'DJ'), ('CE', 'CE'), ('DO', 'DO'), ('DE', 'DE')], default='DJ', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sala', models.CharField(max_length=20, verbose_name='Nombre de la ubicacion')),
                ('siglo_desde', models.CharField(blank=True, max_length=4, verbose_name='Desde siglo')),
                ('siglo_hasta', models.CharField(blank=True, max_length=4, verbose_name='Hasta siglo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adquirido', models.CharField(choices=[('Compra', 'Compra'), ('Donacion', 'Donacion'), ('Legado', 'Legado')], default='1', max_length=8)),
                ('autor', models.ForeignKey(default='1', on_delete=django.db.models.deletion.CASCADE, to='Fondos.Autor')),
                ('contexto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Fondos.Contexto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('justificacion', models.TextField(max_length=80, verbose_name='Justificaci\xf3n de la intervencion')),
        ...
        migrations.AddField(
            model_name='objeto',
            name='ubicacion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Fondos.Ubicacion'),
        ),
        migrations.AddField(
